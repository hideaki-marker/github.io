...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<center>
			...
			<form id="frm1" name="frm1" method="post" action="PostMessagesEx" onsubmit="return frmCheck()">
				<table>
					<tr>
						<th>タイトル</th>
						<td>
							<input type="text" name="title" maxlength="20" size="50"/>
						</td>
					</tr>
					<tr>
						<th>名前</th>
						<td>
							<input type="text" name="name" maxlength="15" size="30" />
						</td>
					</tr>
					<tr>
						<th>編集用パスワード</th>
						<td>
							<input type="password" name="pass" maxlength="10" size="20"/>
						</td>
					</tr>
					<tr>
						<th>内容</th>
						<td>
							<textarea name="messages" cols="70" rows="20"></textarea>
						</td>
					</tr>
					<tr>
