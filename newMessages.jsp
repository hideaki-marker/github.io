...
<!--
	*{padding:5px; margin:0px;}
	 ...
	 td{border:1px black solid; text-aligne:center;}
	 td#button{border:1px black solid; text-aligne:center;}
...
<center>
<h1>新規投稿</h1>
<form id="frm1" name="frm1" method="post" action="PostMessage" >
<table>
...
<tr><th>内容</th><td><textarea name="name" cols="70" rows="20"/></td></tr>
